...
public:
	...
	static constexpr int MINX = 5;
	static constexpr int MINY = 5;
	enum class eKeys { LEFT_FORWARD_P1 = 'q', LEFT_FORWARDCAP_P1 = 'Q', LEFT_BACKWARDS_P1 = 'a', LEFT_BACKWARDSCAP_P1 = 'A',
		...
		SHOOT_P2 = 'i', SHOOTCAP_P2 = 'I', ESC=27
